...
mask = cv2.imread(
    r"C:\Users\bmvan\Documents\datasets\New folder\almost_square.png",
...
new_image = manager.to_binary_mask(mask.shape)
cv2.imwrite("to_binary_mask.png", new_image * 255)
print("done")
